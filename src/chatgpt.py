...
class ChatGTP:
  ...
  def completion(self, new_message_text:str, settings_text:str = '', past_messages:list = [], debug:bool = False):
    """
...
if __name__ == "__main__":
  chatgpt = ChatGTP()
  response_message_text, past_messages = chatgpt.completion("Hello World")
